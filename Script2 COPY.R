...
plot_models(modelo11, modelo12, rm.terms=c("AGE","Settlement_size",
                                           "Interest_in_Politics",
                                           "Scale_of_Incomes","Etnic_Group"))
a<-plot_models(modelo11, modelo12, modelo13, modelo14, modelo15,
            legend.title = "Wave",m.labels = c("1991", "1997", "2006","2014",
                                               "2018"),rm.terms=c("AGE","Settlement_size","Education_Level",
                                                                  "Interest_in_Politics",
                                                                  "Scale_of_Incomes","Etnic_Group"),
            axis.labels=c("Right-wing (ideological self-placement)",
                          "PT",
                          "Post-Materialism", "Education Level",
                          "Be Woman"),show.values = FALSE, 
...
a + labs(caption = "The graph takes into consideration the complete regression model.
         Age, Income Scale, Political Interest,
         and Ethnicity are omitted from the graph;
         the effects of these variables can be viewed in Appendix A.",
         subtitle="Results of full regression models",
         y="Fundamentalism Estimates")
...
# GENDER
median(df1$MR1,na.rm = TRUE) -> median1
mean(df1$MR1,na.rm=TRUE) -> mean1
median(df2$MR1,na.rm = TRUE)-> median2
mean(df2$MR1,na.rm=TRUE) -> mean2
median(df3$MR1,na.rm = TRUE)-> median3
mean(df3$MR1,na.rm=TRUE) -> mean3
median(df4$MR1,na.rm = TRUE)-> median4
mean(df4$MR1,na.rm=TRUE) -> mean4
median(df5$MR1,na.rm = TRUE)-> median5
mean(df5$MR1,na.rm=TRUE) -> mean5
...
SEX91 <- ggplot(grafxx1, aes(y = yy1, x = xx1)) +
  ...
  geom_hline(yintercept = 0, linetype = "dashed", color = "grey",size=1.23) +  # Adicionar linha no zero
  geom_point(x = 1.5, y = median1, color = "red", size = 3) +  # Ponto vermelho
  geom_point(x = 1.5, y = mean1, color = "blue", size = 3, shape = 21, fill = "blue") +  # Círculo azul
...
SEX97 <- ggplot(grafxx1, aes(y = yy1, x = xx1)) +
  geom_bar(stat = "identity", fill = gray(.3)) +
  geom_hline(yintercept = 0, linetype = "dashed", color = "grey",size=1.23) +  # Adicionar linha no zero
  geom_point(x = 1.5, y = median2, color = "red", size = 3) +  # Ponto vermelho
  geom_point(x = 1.5, y = mean2, color = "blue", size = 3, shape = 21, fill = "blue") +  # Círculo azul
  theme_classic(base_size = 18) +
  scale_y_continuous(limits = c(-0.25,0.25)) +
  ggtitle("                    1997") +
  xlab("Gender") + 
...
SEX2006 <- ggplot(grafxx1, aes(y = yy1, x = xx1)) +
  geom_bar(stat = "identity", fill = gray(.3)) +
  geom_hline(yintercept = 0, linetype = "dashed", color = "grey",size=1.23) +  # Adicionar linha no zero
  geom_point(x = 1.5, y = median3, color = "red", size = 3) +  # Ponto vermelho
  geom_point(x = 1.5, y = mean3, color = "blue", size = 3, shape = 21, fill = "blue") +  # Círculo azul
  theme_classic(base_size = 18) +
  scale_y_continuous(limits = c(-0.25,0.25)) +
  ggtitle("                    2006") +
  xlab("Gender") + 
...
SEX14 <- ggplot(grafxx1, aes(y = yy1, x = xx1)) +
  geom_bar(stat = "identity", fill = gray(.3)) +
  geom_hline(yintercept = 0, linetype = "dashed", color = "grey",size=1.23) +  # Adicionar linha no zero
  geom_point(x = 1.5, y = median4, color = "red", size = 3) +  # Ponto vermelho
  geom_point(x = 1.5, y = mean4, color = "blue", size = 3, shape = 21, fill = "blue") +  # Círculo azul
  theme_classic(base_size = 18) +
  scale_y_continuous(limits = c(-0.25,0.25)) +
  ggtitle("                    2014") +
  xlab("Gender") + 
...
SEX18 <- ggplot(grafxx1, aes(y = yy1, x = xx1)) +
  geom_bar(stat = "identity", fill = gray(.3)) +
  geom_hline(yintercept = 0, linetype = "dashed", color = "grey",size=1.23) +  # Adicionar linha no zero
  geom_point(x = 1.5, y = median5, color = "red", size = 3) +  # Ponto vermelho
  geom_point(x = 1.5, y = mean5, color = "blue", size = 3, shape = 21, fill = "blue") +  # Círculo azul
  theme_classic(base_size = 18) +
  scale_y_continuous(limits = c(-0.25,0.25)) +
  ggtitle("                    2018") +
  xlab("Gender") + 
...
SEX18
grid.arrange(SEX91, SEX97, SEX2006, SEX14, SEX18, nrow=2)
...
pm91 <- ggplot(grafxx1, aes(y = yy1, x = xx1)) +
  geom_bar(stat = "identity", fill = gray(.3)) +
  geom_hline(yintercept = 0, linetype = "dashed", color = "grey",size=0.9) +  # Adicionar linha no zero
  geom_point(x = 3.5, y = median1, color = "red", size = 3) +  # Ponto vermelho
  geom_point(x = 3.5, y = mean1, color = "blue", size = 3, shape = 21, fill = "blue") +  # Círculo azul
  theme_classic(base_size = 18) +
...
pm97 <- ggplot(grafxx1, aes(y = yy1, x = xx1)) +
  geom_bar(stat = "identity", fill = gray(.3)) +
  geom_hline(yintercept = 0, linetype = "dashed", color = "grey",size=0.9) +  # Adicionar linha no zero
  geom_point(x = 3.5, y = median2, color = "red", size = 3) +  # Ponto vermelho
  geom_point(x = 3.5, y = mean2, color = "blue", size = 3, shape = 21, fill = "blue") +  # Círculo azul
  theme_classic(base_size = 18) +
  scale_y_continuous(limits = c(-1,1)) +
  ggtitle("                    1997") +
  xlab("Post-Materialist Index") + 
...
pm2006 <- ggplot(grafxx1, aes(y = yy1, x = xx1)) +
  geom_bar(stat = "identity", fill = gray(.3)) +
  geom_hline(yintercept = 0, linetype = "dashed", color = "grey",size=0.9) +  # Adicionar linha no zero
  geom_point(x = 3.5, y = median3, color = "red", size = 3) +  # Ponto vermelho
  geom_point(x = 3.5, y = mean3, color = "blue", size = 3, shape = 21, fill = "blue") +  # Círculo azul
  theme_classic(base_size = 18) +
  scale_y_continuous(limits = c(-1,1)) +
  ggtitle("                    2006") +
  xlab("Post-Materialist Index") + 
...
pm2014 <- ggplot(grafxx1, aes(y = yy1, x = xx1)) +
  geom_bar(stat = "identity", fill = gray(.3)) +
  geom_hline(yintercept = 0, linetype = "dashed", color = "grey",size=0.9) +  # Adicionar linha no zero
  geom_point(x = 3.5, y = median4, color = "red", size = 3) +  # Ponto vermelho
  geom_point(x = 3.5, y = mean4, color = "blue", size = 3, shape = 21, fill = "blue") +  # Círculo azul
  theme_classic(base_size = 18) +
...
pm2018 <- ggplot(grafxx1, aes(y = yy1, x = xx1)) +
  geom_bar(stat = "identity", fill = gray(.3)) +
  geom_hline(yintercept = 0, linetype = "dashed", color = "grey",size=0.9) +  # Adicionar linha no zero
  geom_point(x = 3.5, y = median5, color = "red", size = 3) +  # Ponto vermelho
  geom_point(x = 3.5, y = mean5, color = "blue", size = 3, shape = 21, fill = "blue") +  # Círculo azul
  theme_classic(base_size = 18) +
  scale_y_continuous(limits = c(-1,1)) +
  ggtitle("                    2018") +
  xlab("Post-Materialist Index") + 
...
a <- a + labs(y="Fundamentalism Estimates") +  theme_minimal()
a

b <- b + labs(y="Fundamentalism Estimates") +  theme_minimal()

c <- c + labs(y="Fundamentalism Estimates") +  theme_minimal()

d <- d + labs(y="Fundamentalism Estimates") +  theme_minimal()

e <- e + labs(y="Fundamentalism Estimates") +  theme_minimal()
