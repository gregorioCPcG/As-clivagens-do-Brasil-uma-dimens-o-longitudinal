...
Dataframe_dimension_reduction <- Dataframe[, c("V309","V128","V130","V176","V249","V250","V251","V254","V268","V307","V308","V310","V311","V322","V336","V339","V252","V248","Y001","V351","V352","V147")]

df1991r <- Dataframe[, c("V309","V128","V130","V176","V249","V250","V251","V254","V268","V307","V308","V310","V311","V322","V336","V339","V252","V14","V15","V16","V17","V18","V19","V20","V21","V22","V23","V24")]
...
media_ed <- aggregate(cbind(MR1, V14) ~ V17, data = df1991r, FUN = mean)
...
Dataframe_dimension_reduction <- Dataframe[, c("V61","V63","V190","V124","V125","V126","V128","V114","V197","V198","V199","V200","V205","V127","V134","V154","V155","V156","V157","V159","V160","V161","V162","V163")]
...
media_ed <- aggregate(cbind(MR1, V14) ~ V17, data = df1997r, FUN = mean)
...
Dataframe_dimension_reduction <- Dataframe[, c("V44","V45","V192","V116","V117","V119","V78","V202","V203","V204","V205","V209","V118","V124","V148","V149","V150","V151","V114","Y001","V231","V232","V233","V186")]
...
Dataframe_dimension_reduction <- Dataframe[, c("V44","V45","V192","V116","V117","V119","V78","V202","V203","V204","V205","V209","V118","V124","V148","V149","V150","V151")]
...
Dataframe_dimension_reduction <- Dataframe[, c("V45","V46","V152","V96","V97","V99","V69","V203","V203A","V204","V205","V211","V98","V127","V128","V129","V130","V95","Y001","V228","V145")]
...
Dataframe_dimension_reduction <- Dataframe[, c("V45","V46","V152","V96","V97","V99","V69","V203","V203A","V204","V205","V211","V98","V127","V128","V129","V130")]
...
media_ed <- aggregate(cbind(MR1, V14) ~ V17, data = df2014r, FUN = mean)
...
Dataframe_dimension_reduction <- Dataframe[, c("Q33","Q34","Q164","Q42","Q106","Q107","Q109","Q45","Q182","Q183","Q184","Q185","Q254","Q108","Q130","Q235","Q236","Q237","Q238","Q240","Y001","Q223","Q171")]
...
Dataframe_dimension_reduction <- Dataframe[, c("Q33","Q34","Q164","Q42","Q106","Q107","Q109","Q45","Q182","Q183","Q184","Q185","Q254","Q108","Q130","Q235","Q236","Q237","Q238")]
...
media_ed <- aggregate(cbind(MR1, V14) ~ V17, data = df2018r, FUN = mean)
...
Dataframe_dimension_reduction <- Dataframe[, c("V1","V2","V3","V4","V5","V6","V7","V8","V9","V10","V11","V12","V13")]

df1991 <- Dataframe_dimension_reduction
df1997 <- Dataframe_dimension_reduction
df2006 <- Dataframe_dimension_reduction
df2014 <- Dataframe_dimension_reduction
df2018 <- Dataframe_dimension_reduction
